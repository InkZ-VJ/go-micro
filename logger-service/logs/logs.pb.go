...
type LogResponse struct {
	...
	Serult string `protobuf:"bytes,1,opt,name=serult,proto3" json:"serult,omitempty"`
}
...
func (x *LogResponse) GetSerult() string {
	if x != nil {
		return x.Serult
	}
	return ""
...
var file_logs_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x72, 0x75, 0x6c, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x72, 0x75, 0x6c, 0x74, 0x32, 0x3d, 0x0a,
